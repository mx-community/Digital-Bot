...
if (!text) return conn.sendMessage(m.chat, { text: `Proporcione un enlace de TikTok.\n\n\t\t⚶ Por ejemplo:\n*${usedPrefix + command}* https://vm.tiktok.com/xxxx/` }, { quoted: m })
try {
...
let titulott = `🎬  *${descarg}_tiktok.mp4*`
await m.react("⏰")
...
if (!text) return conn.reply(m.chat, `Proporcione un enlace de TikTok.\n\n\t\t⚶ Por ejemplo:\n${usedPrefix + command} https://vm.tiktok.com/xxxx/`, m);
try {
